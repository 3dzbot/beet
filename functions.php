...
if ( ! function_exists( 'beet_setup' ) ) :
	...
	function beet_setup() {
		...
		register_nav_menus(
			array(
				'main_menu' => esc_html__( 'Главное меню', 'beet' ),
			)
		);
 ...
 */
function beet_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'beet_content_width', 640 );
}
add_action( 'after_setup_theme', 'beet_content_width', 0 );
...
function beet_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'beet' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'beet' ),
